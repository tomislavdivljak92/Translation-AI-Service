async function submitTranslation() {
    ...
    try {
      const response = await axios.post('https://translation-ai-service.onrender.com/translate/translate',{
          text: text,
          languages: languages
      ...
      while (progress < 100) {
        ...
        const resultResponse = await axios.get(`https://translation-ai-service.onrender.com/translate/translate/${taskId}`);
  ...
  async function checkTranslationStatus() {
    ...
    try {
        const response = await axios.get(`https://translation-ai-service.onrender.com/translate/translate/${id}`);
  ...
  async function checkTranslationContent(){
    const id = document.getElementById('search-id').value;
    try {
      const response = await axios.get(`https://translation-ai-service.onrender.com/translate/translate/content/${id}`);
